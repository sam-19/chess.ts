...
describe('Board', () => {
    ...
    test('check initial properties', () => {
        ...
        expect(board.castlingRights.b.contains(Flags.CASTLE_KSIDE)).toStrictEqual(true)
        expect(board.castlingRights.b.contains(Flags.CASTLE_QSIDE)).toStrictEqual(true)
        expect(board.castlingRights.w.contains(Flags.CASTLE_KSIDE)).toStrictEqual(true)
        expect(board.castlingRights.w.contains(Flags.CASTLE_QSIDE)).toStrictEqual(true)
